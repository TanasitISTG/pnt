...
import { ChapterGroupsAccordion } from "@/components/chapters/table/chapter-groups-accordion";
import { ChapterTable, type ChapterTableProps } from "@/components/chapters/table/chapter-table";
