...
import { ChapterStatusBadge, type ChapterStatus } from "@/components/chapter-status-badge";
...
// Row shape the table needs — listChapters rows are a structural superset.
