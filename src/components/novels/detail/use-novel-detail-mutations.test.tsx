...
import * as chapterFunctions from "@/lib/content/chapter/chapter.functions";
...
vi.mock("@/lib/content/novel/novel.functions", () => ({
  deleteNovel: vi.fn(),
  setNovelPublished: vi.fn(),
}));

vi.mock("@/lib/content/chapter/chapter.functions", () => ({
  deleteChapter: vi.fn(),
...
vi.mock("@/lib/content/chapter/chapter-ops.functions", () => ({
