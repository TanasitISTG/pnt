...
const VIEW_MODES: { value: ViewMode; label: string; icon: typeof Columns2 }[] = [
...
function ReaderPage() {
  ...
  return (
    <div
      className={cn(
        settings.theme === "dark" &&
          "dark rounded-xl border border-border bg-background p-4 text-foreground sm:p-6",
      )}
    >
              ...
              <DropdownMenuContent align="end" className="w-44">
                ...
                <DropdownMenuGroup>
                  ...
                  <DropdownMenuRadioGroup
                    ...
                    onValueChange={(v) => update({ theme: v as ReaderTheme })}
                  >
